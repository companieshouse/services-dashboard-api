...
import uk.gov.companieshouse.servicesdashboardapi.ServicesDashboardApiApplication;
...
public class ApiLogger {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(ServicesDashboardApiApplication.SDAPI_APP_NAMESPACE);
